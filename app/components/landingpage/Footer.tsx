      ...
      <div className="mx-auto max-w-7xl px-4 py-8 md:px-6">
        ...
        <div className="flex flex-col items-center justify-between gap-4 md:flex-row">
          ...
          <p className="text-sm text-slate-500">
            © {new Date().getFullYear()} CounselConnect. All rights reserved.
          </p>
          ...
          <div className="flex flex-col items-center gap-3 md:flex-row md:gap-6">
            <div className="flex items-center gap-2 rounded-full bg-slate-100 px-4 py-2 border border-slate-200">
              ...
              <p className="text-sm text-slate-900">
                <span className="font-semibold">Developed by</span> <span className="font-bold text-emerald-600">Saad Mustafa</span>
              </p>
            </div>
