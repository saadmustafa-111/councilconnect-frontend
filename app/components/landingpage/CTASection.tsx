...
export default function CTASection() {
  return (
    <SectionContainer id="get-started">
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 px-6 py-12 text-white shadow-2xl md:px-12 md:py-16">
        {/* Decorative elements */}
        ...
        <div className="relative flex flex-col gap-10 md:flex-row md:items-center md:justify-between md:gap-12">
          ...
          <div className="max-w-xl">
            ...
            <p className="mt-4 text-base text-slate-300 leading-relaxed md:text-lg">
              Join CounselConnect as a client or a lawyer and bring your legal
              journey into one secure, modern platform built for Pakistan.
            </p>
            ...
            <div className="mt-6 flex flex-wrap items-center gap-4 text-sm">
              ...
              <div className="flex items-center gap-2 text-slate-400">
                ...
                <span className="font-medium">Trusted by 1000+</span>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-4 md:w-96">
            ...
            >
              ...
              <div className="relative flex items-center justify-between">
                <div className="flex flex-col text-left">
                  <span className="text-lg font-bold text-white">Get Legal Help as Client</span>
                  <span className="mt-1 text-sm text-emerald-50">
                    Find a verified lawyer and book consultation
                  </span>
                </div>
            ...
            >
              <div className="flex items-center justify-between">
                <div className="flex flex-col text-left">
                  <span className="text-lg font-bold text-white">Join as Lawyer</span>
                  <span className="mt-1 text-sm text-slate-300">
                    Manage cases and grow your practice
                  </span>
                </div>
                <div className="ml-4 flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-full border-2 border-slate-600 group-hover:border-emerald-500 transition-all">
                  <svg className="h-5 w-5 text-slate-300 group-hover:text-emerald-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                  </svg>
                </div>
              </div>
            ...
            <div className="mt-2 flex items-start gap-2 rounded-xl bg-slate-800/30 backdrop-blur-sm border border-slate-700/50 px-4 py-3">
              <svg className="h-5 w-5 flex-shrink-0 text-emerald-400 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clipRule="evenodd" />
              </svg>
              <p className="text-xs text-slate-300 leading-relaxed">
                All lawyers are verified with bar credentials. Client data and
                documents are handled with bank-grade security.
              </p>
            </div>
          </div>
        </div>
